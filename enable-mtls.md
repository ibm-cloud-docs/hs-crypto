...
After you set up the client CA certificate, you are no longer able to access EP11 keystores and EP11 keys through the UI.
{: important}
...
2. Upload the client CA certificate to the server with the following command:
    ...
    {: caption="Describes the variables needed to upload the TLS certificate" caption-side="bottom"}
...
- Configure PKCS #11 applications
    ...
    {: caption="Describes the variables needed to configure PKCS #11 applications" caption-side="bottom"}
...
1. Delete a CA certificate with the following command. Repeat this step to delete all the available certificates on the server to disable the TLS connections from EP11 applications.
    ...
    {: caption="Describes the variables needed to delete CA certificates" caption-side="bottom"}
