...
3. Run the following cURL command to permanently delete the key and the contents.
    ...
    {: caption="Table 1. Describes the variables that are needed to purge keys with the {{site.data.keyword.hscrypto}} key management service API" caption-side="bottom"}
