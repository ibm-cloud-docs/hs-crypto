...
- If you use files, are you going to use recovery crypto units to generate a random master key value and hold the backup copy of the master key?
...
If you decide to use files, you also need to consider the following aspects::

- Where are you going to save backup copies of the file?
