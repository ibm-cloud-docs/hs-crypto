...
# Why can't I rotate master keys using key part files?
{: #troubleshoot-master-key-rotation-key-part-files}
{: troubleshoot}
{: support}

When you run the `ibmcloud tke cryptounit-mk-rotate` command to rotate master keys using key part files, you might be not able to complete the rotation.
{:shortdesc}
