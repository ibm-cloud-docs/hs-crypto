...
After you set up the library and the configuration file, your applications can now use the PKCS #11 library to call the standard PKCS #11 functions. For the detailed list of supported PKCS #11 functions, see [PKCS #11 API reference](/docs/hs-crypto?topic=hs-crypto-pkcs11-api-ref).
