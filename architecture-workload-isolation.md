...
![Service instance components](/images/hs-crypto-components-new.svg "Service instance components"){: caption="Interaction with {{site.data.keyword.hscrypto}} components" caption-side="bottom"}
