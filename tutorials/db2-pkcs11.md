...
![IBM Db2 default encryption using the standard PKCS #11 API](../image/pkcs_db2.svg "IBM Db2 default encryption using the standard PKCS #11 API"){: caption="Figure 1. IBM Db2 default encryption using the standard PKCS #11 API" caption-side="bottom"}
