...
Now you can restore keys that was deleted within 30 days without providing any key materials. All root keys and standard keys, whether generated by {{site.data.keyword.hscrypto}} or imported by you, can be restored. For more information, see [Restoring keys](/docs/hs-crypto?topic=hs-crypto-restore-keys).
