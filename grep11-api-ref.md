...
Keywords: EP11, PKCS#11, GREP11, API reference
...
A GREP11 API endpoint, a service ID API key, an IAM endpoint, and an instance ID are needed for initialization before performing any GREP11 API function calls. For details, see [Generating a GREP11 API request](/docs/services/hs-crypto?topic=hs-crypto-set-up-api#form-grep11-api-request).
...
<!--
grep11 relies on GRPC spec for errors, here is an [introduction](https://grpc.io/docs/guides/error/). GRPC clients, upon error, receives a [`message Status` protocol buffer](https://github.com/grpc/grpc/blob/master/src/proto/grpc/status/status.proto):
```
message Status {
	  // The status code, which should be an enum value of [google.rpc.Code][google.rpc.Code].
	  int32 code = 1;
...
The `Code` field can be cast to `PKCS #11` ***CK_RV*** value. It will contain the error codes defined by [PKCS #11 specification](http://docs.oasis-open.org/pkcs11/pkcs11-base/v2.40/os/pkcs11-base-v2.40-os.html#_Toc416959729), or section `10.1.6` of [Enterprise PKCS #11 Library structure](https://www.ibm.com/downloads/cas/WXRDPRAN). `ep11` only uses a subset of return values `PKCS #11` defines.

Here is an example in [golang that deals with errors](https://github.com/Vincent26-Chen/ibm-cloud-hyperprotectcrypto/blob/master/golang/examples/server_test.go). ***TO BE MERGED***
-->
...
CK_RV m_GenerateRandom (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_GenerateRandom` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
...
CK_RV m_DigestInit (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DigestInit` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DigestInit_EP11}
...
CK_RV m_Digest (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_Digest` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #Digest_EP11}
...
CK_RV m_DigestUpdate (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DigestUpdate` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DigestUpdate_EP11}
...
CK_RV m_DigestKey (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DigestKey` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DigestKey_EP11}
...
CK_RV m_DigestFinal (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DigestFinal` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DigestFinal_EP11}
...
CK_RV m_DigestSingle (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DigestSingle` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DigestSingle_EP11}
...
CK_RV m_EncryptInit (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_EncryptInit` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #EncryptInit_EP11}
...
CK_RV m_DecryptInit (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DecryptInit` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DecryptInit_EP11}
...
CK_RV m_EncryptUpdate (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_EncryptUpdate` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #EncryptUpdate_EP11}
...
CK_RV m_DecryptUpdate (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DecryptUpdate` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DecryptUpdate_EP11}
...
CK_RV m_Encrypt (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_Encrypt` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #Encrypt_EP11}
...
CK_RV m_Decrypt (const unsigned char *state, size_t slen,
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_Decrypt` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #decrypt_EP11}
...
<table>
  <tr>
    <th>Description</th>
    <td><p>`C_Decrypt` decrypts encrypted data in a single part. <ul><li>`hSession` is the session handle.</li> <li>`pEncryptedData` points to the encrypted data.</li> <li>`ulEncryptedDataLen` is the length of the encrypted data.</li> <li>`pData` points to the location that receives the recovered data.</li>  <li>`pulDataLen` points to the location that holds the length of the recovered data.</li></p>
...
CK_RV m_EncryptFinal (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_EncryptFinal` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #EncryptFinal_EP11}
...
CK_RV m_DecryptFinal (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DecryptFinal` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DecryptFinal_EP11}
...
CK_RV m_EncryptSingle (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_EncryptSingle` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #EncryptSingle_EP11}
...
<table>
 ...
 CK_RV m_VerifyInit (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_VerifyInit` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #VerifyInit_EP11}
...
CK_RV m_SignUpdate (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_SignUpdate` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #SignUpdate_EP11}
...
CK_RV m_VerifyUpdate (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_VerifyUpdate` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #VerifyUpdate_EP11}
...
CK_RV m_SignFinal (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_SignFinal` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #SignFinal_EP11}
...
CK_RV m_VerifyFinal (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_VerifyFinal` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #VerifyFinal_EP11}
...
CK_RV m_Sign (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_Sign` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #Sign_EP11}
...
CK_RV m_Verify (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_Verify` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #Verify_EP11}
...
CK_RV m_VerifySingle (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_VerifySingle` return values. For details, see the ***Return values*** chapter of the  <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #VerifySingle_EP11}
...
CK_RV m_GenerateKey (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_GenerateKey` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #GenerateKey_EP11}
...
const unsigned char *pin, size_t pinlen,
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_GenerateKeyPair` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
...
CK_RV m_WrapKey (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_WrapKey` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #WrapKey_EP11}
...
CK_RV m_UnwrapKey (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_UnwrapKey` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #UnwrapKey_EP11}
...
CK_RV m_DeriveKey (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_DeriveKey` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
{: #DeriveKey_EP11}
...
CK_RV m_GetMechanismList (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_GetMechanismList` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
...
CK_RV m_GetMechanismInfo (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_GetMechanismInfo` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
...
CK_RV m_GetAttributeValue (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_GetAttributeValue` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
...
CK_RV m_SetAttributeValue (
  ...
  <tr>
    <th>Return values</th>
    <td>A subset of `C_SetAttributeValue` return values. For details, see the ***Return values*** chapter of the <a href="https://www.ibm.com/downloads/cas/WXRDPRAN" target="_blank">Enterprise PKCS #11 (EP11) Library structure document</a>.</td>
  </tr>
</table>
{: caption="Table 2. EP11" caption-side="top"}
...
For complete examples on Enterprise PKCS #11 (EP11) over gRPC, see [GREP11 examples](https://github.com/vpaprots/ibm-cloud-hyperprotectcrypto/tree/master/golang){:external}.
