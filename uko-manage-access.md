...
{: #table-5}
{: caption="Lists service access roles as they apply to {{site.data.keyword.uko_full_notm}}" caption-side="bottom"}
...
{: #table-8}
{: caption="Lists service access roles as they apply to KMIP adapter" caption-side="bottom"}
