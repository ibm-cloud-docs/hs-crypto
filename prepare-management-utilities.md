...
![The task flow of service instance initialization with smart cards and the Management Utilities](/images/hsm-initialization-flow-smartcard.svg "The task flow of service instance initialization with smart cards and the Management Utilities"){: caption="Task flow of service instance initialization with smart cards and the Management Utilities" caption-side="bottom"}
...
2.  Contact your IBM Sales representative or your IBM Business Partner and provide the following information. 
    ...
    * Shipping contact information, which includes the name, shipping address, phone number, email address, and time zone.
    ...
    For more information about ordering smart cards through your IBM sales representatives or Business Partners, see [How to Order](https://www.ibm.com/docs/en/cryptocards?topic=how-order#how_to_order__order_cards__title__1){: external}.
...
* Contact your IBM Sales representative or your IBM Business Partner to order smart card readers. For more information, see [How to Order](https://www.ibm.com/docs/en/cryptocards?topic=how-order#how_to_order__order_cards__title__1){: external}.
