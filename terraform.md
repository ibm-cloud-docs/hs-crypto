...
# Setting up Terraform for {{site.data.keyword.hscrypto}} Standard Plan
...
This topic only covers how to set up Terraform for {{site.data.keyword.hscrypto}} Standard Plan.
{: note}
