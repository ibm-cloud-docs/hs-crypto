...
|-------------|-----------------|-------------|
| Pre-active  |        0        | A _Pre-active_ key is not yet activated in target keystores and is therefore not available for use by applications. New keys are initially created in the _Pre-active_ state. |
