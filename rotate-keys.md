...
3. Replace the key with new key material by running the following cURL command.
    ...
    {: caption="Describes the variables needed to rotate a specified key in {{site.data.keyword.hscrypto}}" caption-side="bottom"}
...
5. Replace the existing key with new key material by running the following cURL command.
    ...
    {: caption="Describes the variables needed to restore keys with th{{site.data.keyword.hscrypto}} API" caption-side="bottom"}
