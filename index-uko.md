...
# Getting started with {{site.data.keyword.cloud_notm}} with {{site.data.keyword.uko_full_notm}}
{: #get-started-uko}
...
{: #initialize-crypto-dashboard-uko}
{: hide-in-docs}
{: notoc}
...
{: #encrypt-data-hsm-dashboard-uko}
{: hide-in-docs}
{: notoc}
...
{: #cryptographic-operations-with-grep11-dashboard-uko}
...
{: #encrypt-data-hsm-uko}
{: hide-dashboard}

You can remotely access {{site.data.keyword.hscrypto}} cloud HSM to perform cryptographic operations with the PKCS #11 API or with the GREP11 API.

### Performing cryptographic operations with the PKCS #11 API
{: #cryptographic-operations-with-pkcs11-dashboard-uko}
{: help}
{: support}
