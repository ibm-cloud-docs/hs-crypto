...
3. Run the following cURL command to get details about your key and the key material.
    ...
    {: caption="Table 4. Describes the variables that are needed to view a specified key with the {{site.data.keyword.hscrypto}} key management service API" caption-side="bottom"}
