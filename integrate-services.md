...
<table>
    ...
    <tr>
        <td>
          <p>{{site.data.keyword.cloud_notm}} Virtual Private Cloud ({{site.data.keyword.block_storage_is_short}})</p>
        </td>
        <td>
    ...
    <tr>
        <td>
          <p>{{site.data.keyword.cloud_notm}} Virtual Private Cloud ({{site.data.keyword.vsi_is_short}})</p>
        </td>
        <td>
