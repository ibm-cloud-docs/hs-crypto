...
| [{{site.data.keyword.compliance_short}}](/docs/security-compliance) | When you work with the {{site.data.keyword.compliance_short}}, data is generated by the service as you interact with it. | [Protecting your sensitive data](/docs/security-compliance?topic=security-compliance-mng-data#data-encryption) |
