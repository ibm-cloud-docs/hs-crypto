...
keywords: enable mechanisms, BTC, bitcoin mechanism, BIP32, BIP 0032, enable deterministic wallets
...
After some crypto features and mechanisms are enabled in {{site.data.keyword.cloud}} {{site.data.keyword.hscrypto}}, you, as a crypto unit administrator, need to manually enable them in your {{site.data.keyword.hscrypto}} instance before you can start using these features and mechanisms.
...
1. In the CLI, update the TKE CLI plugin to the latest version with the following command:
...
* For more information on the TKE CLI commands, check out the [TKE CLI reference](/docs/hs-crypto-cli-plugin?topic=hs-crypto-cli-plugin-tke_cli_plugin).
* For more information on the PKCS #11 API, check out [Introducing PKCS #11](/docs/hs-crypto?topic=hs-crypto-pkcs11-intro) and [PKCS #11 API reference](/docs/hs-crypto?topic=hs-crypto-pkcs11-api-ref).
* For more information on the GREP11 API, check out [Introducing EP11 over gRPC](/docs/hs-crypto?topic=hs-crypto-grep11_intro) and [GREP11 API reference](/docs/hs-crypto?topic=hs-crypto-grep11-api-ref).
