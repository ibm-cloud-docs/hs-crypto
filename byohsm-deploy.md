...
In order to use your own on-premises hardware security modules (HSMs) for {{site.data.keyword.hscrypto}}, you need to properly configure and deploy the HSMs to work with your service instance.
{: shordesc}

## Before you begin
{: #deploy-byohsm-prerequisites}

Before you can configure and deploy your on-premises HSMs, make sure that you complete the HSM purchase and initial setup based on your vendors guidelines. Currently, {{site.data.keyword.hscrypto}} supports Thales HSM A7xx models only. For more information, see [supported types of HSMs](/docs/hs-crypto?topic=hs-crypto-introduce-bring-your-own-hsm#byohsm-limitation-scope).
...
Before you can [provision a {{site.data.keyword.hscrypto}} instance with Bring Your Own HSM](link), you need to prepare the following information:

You need to provide this information for all HSMs that you want to use for {{site.data.keyword.hscrypto}}.
{: important}
...
After you collect all the information needed and set up the network connectivity, you can contact IBM and [provision a {{site.data.keyword.hscrypto}} instance with Bring Your Own HSM](link).
