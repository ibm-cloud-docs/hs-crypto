...
[After you create an instance of the service](/docs/services/hs-crypto?topic=hs-crypto-provision), complete the following steps to create a standard key with the {{site.data.keyword.hscrypto}} GUI.
